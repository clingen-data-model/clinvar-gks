...
| `members` | [iriReference](iriReference.md) \| [ClinvarAllele](ClinvarAllele.md)[] (unordered) | 0..m | A non-exhaustive list of VRS variation contexts that satisfy the constraints of this categorical variant. |
...
| `definingContext` | [iriReference](iriReference.md) \| [ClinvarAllele](ClinvarAllele.md) | 0..1 |  |
