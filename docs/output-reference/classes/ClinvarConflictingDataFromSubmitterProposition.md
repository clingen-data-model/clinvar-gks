...
A proposition type for germline ClinVar submissions where the submitter's data conflicts with other submitters' data for the same variant-condition pair.
...
| `objectCondition` | `Condition` \| `iriReference` | 1..1 | The condition for which conflicting data exists. |
