...
BEGIN
  ...
  DO
    ...
    -- Step 1: Create temp gene context qualifiers
    ...
    -- Step 2: Create temp mode of inheritance qualifiers
    ...
    -- Step 3: Create temp penetrance qualifiers
    ...
    -- Step 4: Create SCV proposition table
    ...
    -- Step 5: Create SCV target proposition table
