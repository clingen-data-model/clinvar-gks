-- VCV propositions. object is a SINGLE #/condition/ or #/conditionSet/ pointer string
-- (multi-condition VCVs reference a synthetic ConditionSet). type is "CustomProposition" for the 10
-- custom types (specific type in customPropositionType); standard types keep their specific type.
-- subject/object (custom) and subjectVariant/objectCondition|objectTumorType (standard) are unified below.
SELECT
  key AS id,
